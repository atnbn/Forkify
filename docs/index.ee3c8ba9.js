function e(e){return e&&e.__esModule?e.default:e}var t,r,n,i=globalThis,a={},s={},o=i.parcelRequire3a11;null==o&&((o=function(e){if(e in a)return a[e].exports;if(e in s){var t=s[e];delete s[e];var r={id:e,exports:{}};return a[e]=r,t.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){s[e]=t},i.parcelRequire3a11=o),(0,o.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>r,set:e=>r=e,enumerable:!0,configurable:!0});var r,n=new Map;r=function(e,t){for(var r=0;r<t.length-1;r+=2)n.set(t[r],{baseUrl:e,path:t[r+1]})}}),o("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["f9fpV","index.ee3c8ba9.js","eyyUD","icons.c14567a0.svg"]'));const c="https://forkify-api.herokuapp.com/api/v2/recipes/",d="55334a07-c7bc-49b0-ab04-1469a0d1bc00",l=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},u={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmarks:[]},p=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},h=async function(e){try{let t=await l(`${c}${e}?key=${d}`);u.recipe=p(t),u.bookmarks.some(t=>t.id===e)?u.recipe.bookmarked=!0:u.recipe.bookmarked=!1}catch(e){throw(// Temp error handling
console.error(`${e} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`),e)}},m=async function(e){try{u.search.query=e;let t=await l(`${c}?search=${e}&key=${d}`);console.log(t,"data"),u.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),u.search.page=1}catch(e){throw console.error(`${e} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`),e}},g=function(e=u.search.page){u.search.page=e;let t=(e-1)*u.search.resultsPerPage,r=e*u.search.resultsPerPage;// 0
return u.search.results.slice(t,r)},_=function(e){u.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/u.recipe.servings;// newQT = oldQT * newServimgs / old Servings / 2 * 8 / 4 = 4
}),u.recipe.servings=e},f=function(){localStorage.setItem("bookmarks",JSON.stringify(u.bookmarks))},v=function(e){//Add bookmark    
u.bookmarks.push(e),e.id===u.recipe.id&&(u.recipe.bookmarked=!0),f()},b=function(e){// Delete bookmark
let t=u.bookmarks.findIndex(t=>t.id===e);u.bookmarks.splice(t,1),e===u.recipe.id&&(u.recipe.bookmarked=!1),f()};!function(){let e=localStorage.getItem("bookmarks");e&&(u.bookmarks=JSON.parse(e))}();const k=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{// const ingArr = ing[1].replaceAll(' ', '').split(',');
let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient format! Please use the correct format :)");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await l(`${c}?key=${d}`,r);u.recipe=p(n),v(u.recipe)}catch(e){throw e}};var y={};y=new URL("icons.c14567a0.svg",import.meta.url).toString();class w{_data;/**
   ...
   */render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let r=this._generateMarkup();if(!t)return r;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",r)}update(e){this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentElement.querySelectorAll("*"));n.forEach((e,t)=>{let r=i[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))})}_clear(){this._parentElement.innerHTML=""}renderSpinner(){let t=`
    ...
    `;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",r)}}(Fraction=function(e,t){/* double argument invocation */if(void 0!==e&&t)"number"==typeof e&&"number"==typeof t?(this.numerator=e,this.denominator=t):"string"==typeof e&&"string"==typeof t&&(// what are they?
// hmm....
...
},n=Fraction;class $ extends w{_parentElement=document.querySelector(".recipe");_errorMessage="We could not find that recipe. Please try another one!";_message="";addHandlerRender(e){["hashchange","load"].forEach(t=>window.addEventListener(t,e))}addHandlerUpdateServings(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--update-servings");if(!r)return;let{updateTo:n}=r.dataset;+n>0&&e(+n)})}addHandlerAddBookmark(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--bookmark");r&&e()})}_generateMarkup(){return`
...
1===t&&r>1?`
      ...
      `:"")}}var x=new A;class L extends w{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a recipe and bookmark it ;)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>M.render(e,!1)).join("")}}var P=new L;class T extends w{_parentElement=document.querySelector(".upload");_message="Recipe was successfully uploaded";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var R=new T;const j=async function(){try{let e=window.location.hash.slice(1);if(!e)return;E.renderSpinner(),q.update(g()),P.update(u.bookmarks),// 2) Loading recipe
await h(e),E.render(u.recipe)}catch(e){E.renderError(),console.error(e)}},N=async function(){try{q.renderSpinner();// 1) Get search query
let e=S.getQuery();if(!e)return;// 2) Load search results
await m(e),q.render(g()),x.render(u.search)}catch(e){console.log(e)}},O=async function(e){try{R.renderSpinner(),// Upload the new recipe
await k(e),E.render(u.recipe),R.renderMessage(),P.render(u.bookmarks),// Change Id in URL
window.history.pushState(null,"",`#${u.recipe.id}`),// Close form window
setTimeout(function(){R.toggleWindow()},2.5)}catch(e){R.renderError(e.message)}};P.addHandlerRender(function(){P.render(u.bookmarks)}),E.addHandlerRender(j),E.addHandlerUpdateServings(function(e){// Update the recipe servings (in state)
_(e),E.update(u.recipe)}),E.addHandlerAddBookmark(function(){u.recipe.bookmarked?b(u.recipe.id):v(u.recipe),E.update(u.recipe),P.render(u.bookmarks)}),S.addHandlerSearch(N),x.addHandlerClick(function(e){q.render(g(e)),x.render(u.search)}),R.addHandlerUpload(O);//# sourceMappingURL=index.ee3c8ba9.js.map

//# sourceMappingURL=index.ee3c8ba9.js.map
